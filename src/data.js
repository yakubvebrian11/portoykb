...
export const listProyek = [
...

 {
  ...
  "tahun": "2024",
  "desk": "An Automatic Transfer Switch (ATS) layout and control schematic design project focused on developing an automatic system for transferring the electrical power supply from the main source to a backup power source. The project focuses on designing the component layout inside a distribution box panel, with consideration given to space optimization, safe wiring paths, and a structured physical component configuration. The design also includes the development of a control schematic to support the automatic transfer of power sources and ensure safe and organized system operation.
",
  ...
  "tahun": "2024",
  "desk": "A Direct-On-Line (DOL) Control Panel design and simulation project developed for a 1 HP (0.75 kW) three-phase induction motor starting system. The project focuses on designing the panel's 2D/3D physical layout using AutoCAD, along with simulating and validating the control logic using CADe SIMU. The design includes component arrangement, wiring pathway optimization, and protection system coordination to ensure safe system operation in accordance with electrical panel design principles before physical assembly.
",
